...
| `09_l8_matrix_relerr_video.mp4` | Same 4 comparisons, animated through one full rocking cycle in phase (12 bins, settled tail only). Confirms the static instant isn't a fluke: rows 1-2 stay small and rows 3-4 stay large throughout the cycle. |
